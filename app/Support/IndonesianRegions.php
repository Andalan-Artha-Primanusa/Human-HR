...
{
    /**
     * Daftar provinsi Indonesia beserta kota/kabupaten.
     * Format: 'Provinsi' => ['Kota/Kab A', 'Kota/Kab B', ...]
     */
    public static function provincesWithCities(): array
    {
        return [
            'Aceh' => [
                ...
                'Kab. Aceh Utara', 'Kab. Bener Meriah', 'Kab. Bireuen', 'Kab. Nagan Raya', 'Kab. Pidie',
                'Kab. Pidie Jaya', 'Kab. Simeulue',
            ],
            'Sumatera Utara' => [
                'Kota Medan', 'Kota Binjai', 'Kota Gunungsitoli', 'Kota Padang Sidempuan', 'Kota Pematangsiantar',
            ...
            'Kepulauan Riau' => [
                'Kota Batam', 'Kota Tanjung Pinang', 'Kota Tanjung Balai',
            ...
            'DKI Jakarta' => [
                'Kota Jakarta Pusat', 'Kota Jakarta Utara', 'Kota Jakarta Timur', 'Kota Jakarta Selatan',
                'Kota Jakarta Barat', 'Kab. Kepulauan Seribu',
            ],
            'Jawa Barat' => [
                ...
                'Kab. Kuningan', 'Kab. Majalaya', 'Kab. Pangandaran', 'Kab. Purwakarta', 'Kab. Subang',
            ...
            'Jawa Tengah' => [
                ...
                'Kab. Pati', 'Kab. Pekalongan', 'Kab. Pemalang', 'Kab. Purworejo', 'Kab. Rembang',
                'Kab. Semarang', 'Kab. Sragen', 'Kab. Sukoharjo', 'Kab. Tegal', 'Kab. Temanggung',
            ...
            'Jawa Timur' => [
                'Kota Batu', 'Kota Blitar', 'Kota Kediri', 'Kota Lumajang', 'Kota Madiun', 'Kota Malang',
                'Kota Mojokerto', 'Kota Pasuruan', 'Kota Probolinggo', 'Kota Surabaya', 'Kota Trenggalek',
                'Kota Tulungagung',
            ...
            'Nusa Tenggara Timur' => [
                ...
                'Kab. Lembata', 'Kab. Manggarai', 'Kab. Manggarai Barat', 'Kab. Manggarai Timur',
                'Kab. Ngada', 'Kab. Nagekeo', 'Kab. Rote Ndao', 'Kab. Sabu Raijua',
            ...
            'Sulawesi Selatan' => [
                ...
                'Kab. Luwu Timur', 'Kab. Luwu Utara', 'Kab. Maros', 'Kab. Pangkajene Kepulauan',
            ...
            'Papua' => [
                'Kota Jayapura',
                'Kab. Biak Numfor', 'Kab. Keerom', 'Kab. Mamberamo Raya', 'Kab. Mamberamo Tengah',
                'Kab. Numfor', 'Kab. Sarmi', 'Kab. Supiori', 'Kab. Waropen', 'Kab. Yapen',
            ],
            'Papua Barat' => [
                'Kota Sorong',
                'Kab. Fakfak', 'Kab. Kaimana', 'Kab. Manokwari', 'Kab. Manokwari Selatan',
                'Kab. Maybrat', 'Kab. Pegunungan Arfak', 'Kab. Raja Ampat', 'Kab. Sorong',
                'Kab. Sorong Selatan', 'Kab. Tambrauw', 'Kab. Teluk Bintuni', 'Kab. Teluk Wondama',
            ],
            'Papua Selatan' => [
                'Kota Merauke',
            ...
            'Papua Tengah' => [
                'Kota Nabire',
                'Kab. Deiyai', 'Kab. Dogiyai', 'Kab. Intan Jaya', 'Kab. Mimika', 'Kab. Paniai',
                'Kab. Puncak', 'Kab. Puncak Jaya',
            ],
            'Papua Pegunungan' => [
                'Kota Wamena',
            ...
            'Papua Barat Tengah' => [
                'Kab. Fakfak', 'Kab. Kaimana', 'Kab. Teluk Bintuni', 'Kab. Teluk Wondama',
            ],
            'Papua Barat Laut' => [
    ...
    /**
     * Hanya daftar provinsi.
     */
    public static function provinces(): array
    {
        return array_keys(self::provincesWithCities());
    }

    /**
     * Kota/kabupaten untuk provinsi tertentu.
     */
    public static function cities(string $province): array
    {
        return self::provincesWithCities()[$province] ?? [];
    }
}
