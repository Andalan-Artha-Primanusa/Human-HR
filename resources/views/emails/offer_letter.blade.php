      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;">
        ...
        <tr><td style="background:#fff;border:1px solid #eadfd4;border-radius:18px;overflow:hidden;box-shadow:0 16px 45px rgba(59,36,20,.08);">
          ...
          <div style="padding:34px 38px;">
            <div style="display:inline-block;background:#fffaf5;color:#8b5e3c;border:1px solid #eadfd4;border-radius:999px;padding:6px 12px;font-size:12px;font-weight:800;">Offering Letter</div>
            <h1 style="margin:18px 0 10px;color:#0f172a;font-size:24px;line-height:1.25;">Halo, {{ $candidateName }}</h1>
            <p style="margin:0 0 18px;color:#475569;font-size:15px;line-height:1.65;">Kami mengirimkan informasi offering untuk posisi <strong style="color:#0f172a;">{{ $jobTitle }}</strong>.</p>
