...
@section('content')
    ...
    <x-admin.page-header title="Sites" description="Kelola daftar site / lokasi operasional.">
      <a href="{{ route('admin.sites.create') }}" class="ph-action">
        ...
        <form method="GET" class="grid grid-cols-1 gap-4 md:grid-cols-[minmax(0,1fr)_200px_auto] md:items-end" role="search" aria-label="Filter Sites">
          ...
          <div class="flex flex-col gap-2 sm:flex-row sm:justify-end">
            ...
            @if(request()->filled('q') || request()->filled('status'))
                  <a href="{{ route('admin.sites.index') }}" class="abtn abtn-neutral">
                    Reset
                  </a>
            @endif
          </div>
