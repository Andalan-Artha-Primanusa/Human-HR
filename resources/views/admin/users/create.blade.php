...
<form method="POST" action="{{ route('admin.users.store') }}" class="grid gap-4 max-w-xl">
  ...
  <div class="flex items-center gap-2">
    ...
    <input type="checkbox" name="active" value="1" id="active" class="rounded" {{ old('active', '1') ? 'checked' : '' }}>
  ...
  <div class="flex items-center gap-2">
    ...
    <button class="px-3 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white">Save</button>
  </div>
</form>
@endsection
