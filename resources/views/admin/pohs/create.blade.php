...
<div class="mx-auto w-full max-w-[960px] px-4 sm:px-6 lg:px-8 py-6 space-y-6">
    ...
    <x-admin.page-header eyebrow="MANAGEMENT" title="Tambah POH" description="Buat Place of Hire baru.">
      ...
      <button type="submit" form="pohCreateForm" class="ph-action ph-action--brand">
    ...
    <section class="bg-white border shadow-sm rounded-2xl" style="border-color: {{ $BORD }}">
        <form id="pohCreateForm" action="{{ route('admin.pohs.store') }}" method="POST" class="p-6 space-y-5 md:p-7 bg-white">
            @csrf
