...
@section('content')
    ...
    <div class="mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8 py-6 space-y-6">
      ...
      {{-- HEADER — shared component (satu warna, tanpa split dua-tone) --}}
      <x-admin.page-header title="Jobs" description="Kelola lowongan, filter cepat, dan tindakan edit/hapus.">
        <a href="{{ route('admin.jobs.create') }}" class="ph-action">
