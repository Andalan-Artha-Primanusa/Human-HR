            ...
            <form id="confirmForm" method="POST" action="{{ route('password.confirm') }}" class="space-y-5" novalidate>
              ...
              <div>
                <div class="flex items-center justify-between">
                  ...
                  <span id="capsInfo" class="hidden text-xs text-amber-700">Caps Lock aktif</span>
                </div>
                <div class="relative mt-1">
                  ...
                  <input id="password" type="password" name="password" required
                         ...
                         class="block w-full pr-10 rounded-lg shadow-sm border-slate-300 pl-9 focus:border-blue-600 focus:ring-blue-600"/>
                  <button type="button" id="togglePw"
                    ...
                    <svg id="eyeOff" class="hidden w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
